...
import com.jdkcb.mybatisstuday.common.DynamicDataSource;
...
/**
 * 配置多个数据源，并使用DynamicDataSource在程序运行时动态切换数据源
 */
@Configuration
@MapperScan(basePackages = "com.jdkcb.mybatisstuday.mapper", sqlSessionFactoryRef = "SqlSessionFactory") //basePackages 我们接口文件的地址
public class DynamicDataSourceConfig {
    ...
    public SqlSessionFactory SqlSessionFactory(@Qualifier("dynamicDataSource") DataSource dynamicDataSource)
        ...
        bean.setMapperLocations(
                new PathMatchingResourcePatternResolver().getResources("classpath*:mapping/*.xml"));//注意这里的路径，设置我们的xml文件路径
